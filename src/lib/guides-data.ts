...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "The cost comparison", content: "DIY costs R$0-7 at the office plus your time. If everything goes right on the first try, you save $29. If it does not, you lose half a day minimum and potentially multiple days across multiple attempts.\n\nGET CPF costs $29 plus R$0-7 at the office. You get a personalised Ready Pack, document checklist, office finder, Portuguese phrases guide, and a money-back guarantee. If you follow our steps and still get rejected, we refund you in full.\n\nThe question is not whether $29 is worth a CPF. The question is whether $29 is worth avoiding a wasted day." },
      CTA_SECTION,
    ],
  },
  {
