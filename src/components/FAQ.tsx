...
const faqs = [
  ...
  { q: "Why should I pay $49 when CPF registration is free?", a: "You're right — the CPF itself is free at the Receita Federal (or R$7 at Correios). We don't charge for the CPF. We charge for the preparation that makes your visit work first time. About one in five foreigners gets rejected on their first attempt because of a wrong office, a name formatting issue, or an invalid proof of address. Each failed visit costs you half a day. The $49 covers pre-filled forms, the correct office for your city, a Portuguese cheat sheet, and a document checker — so you go once, and it works. If it doesn't, we refund you." },
  ...
  { q: "What do you do with my passport and personal documents?", a: "Your documents are used only to prepare your CPF application. We use encryption to protect sensitive fields. All personal data is permanently and automatically deleted from our systems within 48 hours of your CPF being delivered, or immediately if you request it. We never sell or share your data with anyone. You can read our full Privacy Policy for details." },
