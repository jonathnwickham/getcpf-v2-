...
const faqs = [
  ...
  { q: "Is it really free to get a CPF?", a: "At a Receita Federal office, yes, completely free. At Correios (the post office), there's a R$7 fee, about $1.30. Banco do Brasil and Caixa are free if you have an account, R$7 if you don't. Our $49 covers the preparation that saves you a full day of research, wrong forms, and wasted trips." },
