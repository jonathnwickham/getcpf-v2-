...
const faqs = [
  ...
  { q: "Do you actually issue the CPF?", a: "No, only the Brazilian government does that. We make sure you show up with the right documents, at the right office, with everything filled in correctly. That's what the $29 covers: preparation that works first time." },
