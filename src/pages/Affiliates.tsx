  ...
  <div className="overflow-x-hidden">
    ...
    <div className="min-h-screen bg-white pt-28 pb-16 px-6">
      <div className="max-w-[700px] mx-auto">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-4 text-gray-500">
          <p className="text-gray-900 font-medium">Last updated: 29 March 2026</p>
          ...
          <h2 className="text-gray-900 text-lg font-bold mt-8">What this means</h2>
          <p>
          ...
          <h2 className="text-gray-900 text-lg font-bold mt-8">Our commitment</h2>
          ...
          <h2 className="text-gray-900 text-lg font-bold mt-8">Current partners</h2>
          ...
          <h2 className="text-gray-900 text-lg font-bold mt-8">Questions?</h2>
          <p>
            If you have any questions about our affiliate relationships, contact us at{" "}
            <a href="mailto:jonathan@getcpf.com" className="text-green-800 hover:underline font-semibold">
              jonathan@getcpf.com
            </a>.
          </p>
        </div>
